...
d3.custom.lineChart = function module() {
	...
	exports.mobileThreshold = function(_x) {
		//takes a number
		if(!arguments.length) return mobileThreshold;
		mobileThreshold = _x;
		return this;
	}

	exports.yTickSize = function(_x) {
		//takes a number. fixes number of ticks for y axis
		if(!arguments.length) return yTickSize;
		yTickSize = _x;
		return this;
	}
